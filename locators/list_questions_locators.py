...
question_want_several_scooters = [By.XPATH,
                                  "//div[text()='Хочу сразу несколько самокатов! Так можно?']"]  # второй вопрос
...
question_renew_or_return_scooter = [By.XPATH,
                                    "//div[text()='Можно ли продлить заказ или вернуть самокат раньше?']"]  # пятый
# вопрос
question_charging_together_scooter = [By.XPATH,
                                      "//div[text()='Вы привозите зарядку вместе с самокатом?']"]  # шестой вопрос
